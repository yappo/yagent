...
func builtInAgents() map[string]domain.AgentSpec {
	return map[string]domain.AgentSpec{
		"manager": {
			...
			AllowedTools:  []string{"file_reader", "file_writer", "directory_list", "fs_read", "fs_write", "fs_list", "fs_stat", "search_text", "search_files", "git_status", "git_diff", "git_log", "git_show", "task_list", "task_run", "patch_apply"},
			MaxTurns:      200,
			BuiltIn:       true,
			AllowOverride: true,
		},
		"planner": {
			...
			Instruction:  "Break the task into a practical plan with explicit constraints and deliverables. Do not delegate to coder for simple repository inspection tasks. Prefer direct read-only tools such as directory_list and file_reader.",
			Mode:         domain.AgentModeTool,
			ReadOnly:     true,
			AllowedTools: []string{"file_reader", "directory_list", "fs_read", "fs_list", "fs_stat", "search_text", "search_files", "git_status", "git_diff", "git_log", "git_show", "task_list"},
			MaxTurns:     200,
			BuiltIn:      true,
		},
		"researcher": {
			...
			Instruction:  "Inspect available context and files, then return only the most relevant findings. Prefer directory_list and file_reader instead of asking another agent to write scripts.",
			Mode:         domain.AgentModeTool,
			ReadOnly:     true,
			AllowedTools: []string{"file_reader", "directory_list", "fs_read", "fs_list", "fs_stat", "search_text", "search_files", "git_status", "git_diff", "git_log", "git_show", "task_list"},
			MaxTurns:     200,
		...
		"tester": {
			...
			Mode:         domain.AgentModeTool,
			ReadOnly:     true,
			AllowedTools: []string{"file_reader", "directory_list", "fs_read", "fs_list", "fs_stat", "search_text", "search_files", "git_status", "git_diff", "git_log", "git_show", "task_list", "task_run"},
			MaxTurns:     200,
			BuiltIn:      true,
		},
		"reviewer": {
